//
//  2208.halveArray.swift
//  leetcode
//
//  Created by Xiaonan Chen on 2023/7/25.
//
    ...
    class PriorityQueue<T: Comparable> {
        ...
        private func siftDown(from index: Int) {
            ...
            while child < count {
                ...
                if array[smallest] < array[parent] {
                    array.swapAt(parent, smallest)
                    child = smallest
                    smallest = 2 * child + 1
                } else {
                    return
