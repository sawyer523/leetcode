//
//  1125.smallestSufficientTeam.swift
//  leetcode
//
...
func smallestSufficientTeam(_ req_skills: [String], _ people: [[String]]) -> [Int] {
    ...
    var dp = [Int](repeating: m, count: 1 << n)
    dp[0] = 0
    var prevSkill = [Int](repeating: 0, count: 1 << n)
    var prevPeople = [Int](repeating: 0, count: 1 << n)
